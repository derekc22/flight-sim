...
namespace propulsion {
	...
	dynamics::Wrench_T<double> compute_propulsive_loads(const actuators::PropulsorActuators& propulsors,
	    const constants::Vector3_T<double>& center_of_gravity,
	    const dynamics::Twist_T<double>& vehicle_twist,
	    const atmospheric::StaticAtmosphericState& atmosphere,
