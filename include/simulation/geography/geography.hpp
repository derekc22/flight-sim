...
namespace geography {
    ...
    /** @brief Given the position of an object WRT the ECEF frame expressed the ECEF frame (pE), this function returns the local gravity vector at that position expressed in the ECEF frame (gE) 
