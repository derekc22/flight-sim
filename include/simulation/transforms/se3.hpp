...
namespace transforms {
    ...
    * @brief Creates a homogeneous transformation matrix
    *
    * @details Given a rotation matrix “R” and a translation vector "d" whose combined action transforms frame {0} into frame {1},
               this function returns a homogeneous transformation matrix "H" representing that transformation
    *
    ...
    *
    * @return homogeneous transformation matrix "H" that transforms frame {0} into frame {1}
    */
    Eigen::Matrix4d make_HR(const Eigen::Matrix3d& R, const Eigen::Vector3d& d, const std::string& first);

    /**
    * @brief Creates an inverse homogeneous transformation matrix
    *
    * @details Given a homogeneous transformation matrix “H" that transforms frame {0} into frame {1},
            this function returns the inverse homogeneous transformation matrix "H^-1" that transforms frame {1} back into frame {0}
    *
    * @param H homogeneous transformation matrix that transforms frame {0} into frame {1}
    *
    * @return homogeneous transformation matrix "H^-1" that transforms frame {1} back into frame {0}
    */
    Eigen::Matrix4d make_Hinv(const Eigen::Matrix4d& H);

    /**
    * @brief Applies a homogeneous transformation matrix
    *
    * @details Given a homogeneous transformation matrix “H" that transforms frame {0} into frame {1} and a vector "p" expressed WRT frame {1}
            this function returns the inverse homogeneous transformation matrix "H^-1" that transforms frame {1} back into frame {0}
    *
    * @param H homogeneous transformation matrix that transforms frame {0} into frame {1}
    *
    ...
    */
    ...
    // /**
    // * @brief Performs an active homogeneous transformation
    // *
    // * @details Given vector “v0” expressed WRT frame {0} and a homogeneous transformation matrix "H" that transforms vector "v0" into vector "v1" WRT frame {0},
    //         this function returns vector "v1" expressed WRT frame {0}
    // *
    // * @param H homogeneous transformation matrix that transforms vector v0 into v1
    ...
    // /**
    // * @brief Performs a passive homogeneous transformation
    // *
    // * @details Given vector “p” expressed WRT frame {0} and a homogeneous transformation matrix "H" that transforms frame {0} into frame {1},
