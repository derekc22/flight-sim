...
namespace actuators {
    ...
    struct PropulsorActuator : Actuator {
        ...
        PropulsorActuator(double limit_max, double limit_min, double tau, double inclination_angle, double toe_angle, const Eigen::Vector3d& pB_propB, std::optional<PropellerAssembly> propellers = std::nullopt);
        PropulsorActuator();
    };
