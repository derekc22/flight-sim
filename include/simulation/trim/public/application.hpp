...
namespace trim
{
	 ...
	 *
	 * Preserves position and yaw while replacing translational velocity, angular velocity, roll, and pitch.
	 *
	 ...
	 *
	 * Updates all surface and propulsor actuator lag states to their trimmed commands.
	 *
