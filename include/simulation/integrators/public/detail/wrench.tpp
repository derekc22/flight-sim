...
namespace integrators {
	    ...
	    bool steady_state)
	{
		...
		const propulsion::PropulsionManagerInput_T<T> propulsion_input{.propulsors = model.propulsor_actuators,
		    .pB_GB = pB_GB,
		    .twist = twist,
		    .atm = atm,
		...
		return {.WB_set = {.aerodynamic = WB_aerodynamic,
		            .propulsive = WB_propulsive,
		            .net = {.F = WB_aerodynamic.F + WB_propulsive.F + T(model.struc_t.mass.data) * gB,
