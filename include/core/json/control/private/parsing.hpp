...
namespace json
{
	...
	control::AttitudeControl make_attitude_control(control::ControllerType controller_type,
		const nlohmann::json& controller_json);
	control::VelocityControl make_velocity_control(control::ControllerType controller_type,
		const nlohmann::json& controller_json);
	control::LinearQuadraticControl make_linear_quadratic_control(control::ControllerType controller_type,
		const nlohmann::json& controller_json);
	...
	void parse_attitude_control(const nlohmann::json& controller_json,
		std::optional<control::AttitudeControl>& component,
		control::ControllerType& controller_type);
	void parse_velocity_control(const nlohmann::json& controller_json,
		std::optional<control::VelocityControl>& component,
		control::ControllerType& controller_type);
	void parse_linear_quadratic_control(const nlohmann::json& controller_json,
