		...
		const TrimProblem problem{
			...
			.initial_guess = operating::OperatingPoint_T<double>{
				...
				.input = actuators::ActuatorInputs_T<double>{
					...
					.propulsor_inputs = {
						.front_propulsor_cmd =
							0.5 * (propulsor_limit_max.front_propulsor_cmd + propulsor_limit_min.front_propulsor_cmd),
						.left_propulsor_cmd =
							0.5 * (propulsor_limit_max.left_propulsor_cmd + propulsor_limit_min.left_propulsor_cmd),
						.right_propulsor_cmd =
							0.5 * (propulsor_limit_max.right_propulsor_cmd + propulsor_limit_min.right_propulsor_cmd)
					}
				}
			}
		};
