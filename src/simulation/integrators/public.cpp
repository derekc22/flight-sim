...
namespace integrators {
    ...
    dynamics::RigidBodyState step_rigid_body(const dynamics::RigidBodyState& XB_BI_t, const dynamics::Mass& mass, const dynamics::InertiaTensor& JB, const dynamics::Wrench& WB_net_t, double dt) {
        ...
        const dynamics::TranslationalVelocity vB_BI_t1 = trans_dyn_vel(XB_BI_t.v, XB_BI_t.w, mass, FB_net_t, dt);
        ...
        const dynamics::AngularVelocity wB_BI_t1 = rot_dyn(XB_BI_t.w, JB, MB_net_t, dt);

        // Quaternion rotational kinematics
        const dynamics::OrientationQuaternion qIB_t1 = quat_kin(XB_BI_t.q, XB_BI_t.w, dt);
        ...
        const dynamics::Position pI_BI_t1 = trans_kin(XB_BI_t.p, vI_BI_t, aI_BI_t, dt);
