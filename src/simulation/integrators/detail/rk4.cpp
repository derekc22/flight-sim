...
namespace integrators {
    ...
    RK4Output step_rigid_body_rk4(const dynamics::RigidBodyState& Xt, RK4Model& model, const operating::OperatingConditions& conditions, const actuators::ActuatorInputs_T<double>& u, double dt) {
        ...
        const dynamics::WrenchSet& wrench_1 = evaluation_1.wrench;
        ...
        const dynamics::WrenchSet& wrench_2 = evaluation_2.wrench;
        ...
        const dynamics::WrenchSet& wrench_3 = evaluation_3.wrench;
        ...
        const dynamics::WrenchSet& wrench_4 = evaluation_4.wrench;
        ...
        model.propulsion.commit(evaluation_1.next_propulsion_state);
