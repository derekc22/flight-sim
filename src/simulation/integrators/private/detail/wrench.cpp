...
namespace integrators
{
		...
		double dt)
	{
		...
		return {
			.WB_set =
				{.aerodynamic =
						{.F = dynamics::Force{WB_set.aerodynamic.F}, .M = dynamics::Moment{WB_set.aerodynamic.M}},
					.propulsive =
						{.F = dynamics::Force{WB_set.propulsive.F}, .M = dynamics::Moment{WB_set.propulsive.M}},
