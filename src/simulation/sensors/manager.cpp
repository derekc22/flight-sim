...
namespace sensors {
	...
	SensorManagerOutput SensorManager::step(
	    const SensorManagerInput& input)
	{
		SensorMeasurements sensor_meas{.alpha = sensors.aoa_vane.measure(input.sensor_gt.alpha, input.dt),
