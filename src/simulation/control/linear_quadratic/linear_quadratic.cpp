...
namespace control {
    ...
    types::ActuatorInputsVector_T<double> LinearQuadraticController::step(const LinearQuadraticControllerInput& controller_input) {
        ...
        types::StateVector_T<double> zN_t_deviation = controller_input.zN_t - controller_input.zN_t_des;

        types::ActuatorInputsVector_T<double> u_deviation;
