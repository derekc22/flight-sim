...
namespace avionics {
    ...
    PositionMeasurement InertialNavigationSystem::compute(const PositionMeasurement& prev_pI_BI, const TranslationalVelocityMeasurement& prev_vB_BI, const TranslationalAccelerationMeasurement& fB, const dynamics::Gravity& gB, const OrientationMeasurement& prev_qIB) {
    ...
    TranslationalVelocityMeasurement InertialNavigationSystem::compute(const TranslationalVelocityMeasurement& prev_vB_BI, const TranslationalAccelerationMeasurement& fB, const dynamics::Gravity& gB, const AngularVelocityMeasurement& wB_BI) {
