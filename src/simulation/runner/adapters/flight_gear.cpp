...
namespace runner {
    ...
    FlightGearAdapterOutput FlightGearAdapter::receive(const FlightGearAdapterInput& input) {
    ...
    void FlightGearAdapter::send(const FlightGearAdapterSendInput& input) {
