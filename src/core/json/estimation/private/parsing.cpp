...
namespace json {
    ...
    void parse_linear_kalman_estimator(const nlohmann::json& estimator_json, std::optional<estimation::LinearKalmanEstimator>& estimator) {
        estimator = make_linear_kalman_estimator(fetch_estimator_type(estimator_json), estimator_json);
    }

    void parse_extended_kalman_estimator(const nlohmann::json& estimator_json, std::optional<estimation::ExtendedKalmanEstimator>& estimator) {
