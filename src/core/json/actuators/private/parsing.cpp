...
namespace json {
	...
	actuators::PropellerAssembly parse_propellers(
	    ...
	    const Eigen::Vector3d& n_prop)
	{
		...
		return {.geometry_ids = geometry_ids,
	    ...
	    structural::StructuralManager& structural_manager)
	{
		...
		actuators::PropulsorActuators propulsor_actuators = {
		    .front_propulsor = parse_propulsor_actuator<actuators::FrontPropulsorActuator>(
		        propulsor_actuator_json, "front_propulsor", structural_manager),
		    .left_propulsor = parse_propulsor_actuator<actuators::LeftPropulsorActuator>(
		        propulsor_actuator_json, "left_propulsor", structural_manager),
		    .right_propulsor = parse_propulsor_actuator<actuators::RightPropulsorActuator>(
		        propulsor_actuator_json, "right_propulsor", structural_manager),
		};
