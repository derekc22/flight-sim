...
namespace json
{
		...
		const std::string& controller_type_str)
	{
		...
		if (controller_type_str == "DamperPID") {
			return control::ControllerType::DamperPID;
		}
		if (controller_type_str == "VelocityPID") {
			return control::ControllerType::VelocityPID;
		}
		if (controller_type_str == "LinearQuadraticRegulator") {
			return control::ControllerType::LinearQuadraticRegulator;
		}
		if (controller_type_str == "LinearQuadraticIntegrator") {
			return control::ControllerType::LinearQuadraticIntegrator;
		}
		if (controller_type_str == "LinearQuadraticTracker") {
			return control::ControllerType::LinearQuadraticTracker;
		}
		if (controller_type_str == "FeedbackLinearization") {
			return control::ControllerType::FeedbackLinearization;
		}
		if (controller_type_str == "NonlinearDynamicInversion") {
			return control::ControllerType::NonlinearDynamicInversion;
		}
		if (controller_type_str == "IncrementalNonlinearDynamicInversion") {
			return control::ControllerType::IncrementalNonlinearDynamicInversion;
		}
