...
def init_plot(spatial=False):
    ...
    parser.add_argument("--data", "-d", type=Path, help="Data file path")
    parser.add_argument("--ref", "-r", type=Path, help="Reference data file path")
    parser.add_argument("--save", "-s", type=Path, help="Plot save directory")
    ...
    save_fname = data_path.stem
    if spatial: 
        save_fname += "_3d" 
    save_path = plot_dir_path / f"{save_fname}.{args.ext}"
